...
import numpy as np
from .rptc_features import extract_rptc_features
...
class AIDE_Model(nn.Module):
    ...
    def forward(self, x):
        ...
        x_rptc_0 = extract_rptc_features(x_minmin)
        x_rptc_1 = extract_rptc_features(x_maxmax)
        x_rptc_2 = extract_rptc_features(x_minmin1)
        x_rptc_3 = extract_rptc_features(x_maxmax1)
        ...
        x_1 = (x_rptc_0 + x_rptc_1 + x_rptc_2 + x_rptc_3) / 4  # [B, 8]
